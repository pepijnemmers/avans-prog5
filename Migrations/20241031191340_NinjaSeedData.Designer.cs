...
namespace NinjaApp.Migrations
{
    ...
    [Migration("20241031191340_NinjaSeedData")]
    partial class NinjaSeedData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NinjaApp.Models.Ninja", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a0907f17-9be6-4ce5-ae4e-705f1fc1e88d"),
                            Gold = 2000,
                            Name = "Shadowstrike Kenji"
                        },
                        new
                        {
                            Id = new Guid("43ecf84c-e0f3-4e10-bc37-58600dbabc5d"),
                            Gold = 500,
                            Name = "Crimson Whisper"
                        },
                        new
                        {
                            Id = new Guid("f2ea3608-1fb2-4c1d-ab92-9202ac544ec6"),
                            Gold = 2000,
                            Name = "Nightwind Taro"
                        });
                });
